...
export const TEAMS: Team[] = [
  { id: 1, name: 'Korean White Tigers', nameParts: ['Korean', 'White Tigers'], country: 'South Korea', bgColor: '#EAEAEA', textColor: '#001F60' },
  { id: 2, name: 'USA Eagles', nameParts: ['USA', 'Eagles'], country: 'USA', bgColor: '#002868', textColor: '#FFFFFF' },
  { id: 3, name: 'Dutch Lions', nameParts: ['Dutch', 'Lions'], country: 'Netherlands', bgColor: '#F47920', textColor: '#FFFFFF' },
  { id: 4, name: 'Belgium Ice Bears', nameParts: ['Belgium', 'Ice Bears'], country: 'Belgium', bgColor: '#F0F0F0', textColor: '#000000' },
  { id: 5, name: 'Canadian Ice Maples', nameParts: ['Canadian', 'Ice Maples'], country: 'Canada', bgColor: '#1A1A1A', textColor: '#FF0000' },
  { id: 6, name: 'Chinese Loongs', nameParts: ['Chinese', 'Loongs'], country: 'China', bgColor: '#EE1C25', textColor: '#FFFF00' },
  { id: 7, name: 'Polish Hussars', nameParts: ['Polish', 'Hussars'], country: 'Poland', bgColor: '#FFFFFF', textColor: '#DC143C' },
  { id: 8, name: 'Italian Gladiators', nameParts: ['Italian', 'Gladiators'], country: 'Italy', bgColor: '#0055A4', textColor: '#FFFFFF' },
  { id: 9, name: 'Kazakh Nomads', nameParts: ['Kazakh', 'Nomads'], country: 'Kazakhstan', bgColor: '#1E2952', textColor: '#F0E14A' },
  { id: 10, name: 'Japanese Ninjas', nameParts: ['Japanese', 'Ninjas'], country: 'Japan', bgColor: '#FFFFFF', textColor: '#BC002D' },
  { id: 11, name: 'Hungarian Falcons', nameParts: ['Hungarian', 'Falcons'], country: 'Hungary', bgColor: '#231F20', textColor: '#FFFFFF' },
  { id: 12, name: 'French Roosters', nameParts: ['French', 'Roosters'], country: 'France', bgColor: '#002395', textColor: '#FFFFFF' },
  { id: 13, name: 'British Royals', nameParts: ['British', 'Royals'], country: 'Great Britain', bgColor: '#012169', textColor: '#FFFFFF' },
  { id: 14, name: 'Ukrainian Wild Cats', nameParts: ['Ukrainian', 'Wild Cats'], country: 'Ukraine', bgColor: '#0057B7', textColor: '#FFDD00' },
  { id: 15, name: 'Croatian Dalmatians', nameParts: ['Croatian', 'Dalmatians'], country: 'Croatia', bgColor: '#1C1C1C', textColor: '#FFFFFF' },
  { id: 16, name: 'German Wolves', nameParts: ['German', 'Wolves'], country: 'Germany', bgColor: '#1C1C1C', textColor: '#FFCE00' },
  { id: 17, name: 'Czechia Ice Spiders', nameParts: ['Czechia', 'Ice Spiders'], country: 'Czechia', bgColor: '#003153', textColor: '#FFFFFF' },
  { id: 18, name: 'Bulgarian Kings', nameParts: ['Bulgarian', 'Kings'], country: 'Bulgaria', bgColor: '#222222', textColor: '#FFFFFF' },
  { id: 19, name: 'Latvian Golden Stars', nameParts: ['Latvian', 'Golden Stars'], country: 'Latvia', bgColor: '#FDFBF8', textColor: '#A4343A' },
  { id: 20, name: 'Australian Racing Roos', nameParts: ['Australian', 'Racing Roos'], country: 'Australia', bgColor: '#006A4E', textColor: '#FFCD00' },
  { id: 21, name: 'Turkish Anatolian Pars', nameParts: ['Turkish', 'Anatolian Pars'], country: 'Turkey', bgColor: '#212121', textColor: '#FFFFFF' },
  { id: 22, name: 'Hong Kong Ice Qilins', nameParts: ['Hong Kong', 'Ice Qilins'], country: 'Hong Kong', bgColor: '#E40001', textColor: '#FFFFFF' },
  { id: 23, name: 'New Zealand Ice Keas', nameParts: ['New Zealand', 'Ice Keas'], country: 'New Zealand', bgColor: '#121212', textColor: '#FFFFFF' },
  { id: 24, name: 'Irish Wolf Hounds', nameParts: ['Irish', 'Wolf Hounds'], country: 'Ireland', bgColor: '#009A44', textColor: '#FFFFFF' },
  { id: 25, name: 'Swiss Ibex', nameParts: ['Swiss', 'Ibex'], country: 'Switzerland', bgColor: '#DA291C', textColor: '#FFFFFF' },
  { id: 26, name: 'Norwegian Vikings', nameParts: ['Norwegian', 'Vikings'], country: 'Norway', bgColor: '#BA0C2F', textColor: '#FFFFFF' },
  { id: 27, name: 'Thai Elephants', nameParts: ['Thai', 'Elephants'], country: 'Thailand', bgColor: '#3C3658', textColor: '#FFFFFF' },
  { id: 28, name: 'Singapore Gazelles', nameParts: ['Singapore', 'Gazelles'], country: 'Singapore', bgColor: '#ED2939', textColor: '#FFFFFF' },
  { id: 29, 'name': 'Philippine Tamaraws', nameParts: ['Philippine', 'Tamaraws'], country: 'Philippines', bgColor: '#0038A8', textColor: '#FCD116' },
];
